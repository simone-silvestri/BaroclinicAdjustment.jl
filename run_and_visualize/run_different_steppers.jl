...
# OMP25 test case AB2
omp25AB2_test = TestCase(energy_conserving, omp25, "omp25AB2", :QuasiAdamsBashfort2)

# OMP25 test case RK3
omp25RK3_test = TestCase(energy_conserving, omp25, "omp25RK3", :SplitRungeKutta3)

# W9V test case AB2
w9vAB2_test  = TestCase(best_weno, nothing, "wenoAB2", :QuasiAdamsBashfort2)
...
for (resolution, trailing_character) in zip(resolutions, resnames)
   for test in all_tests    
      ...
      simulation = BaroclinicAdjustment.baroclinic_adjustment_latlong(test, 1/16, "_sixteen"; 
                                                                      arch = GPU(),
