...
function plot_all()
    ...
    Ew4  = @lift(  en4["weno5dd"].RPE[1:$iter] ./ 1.538 ./ 1e21)
    El4  = @lift( en4["lapleith"].RPE[1:$iter] ./ 1.538 ./ 1e21)
    Eb4  = @lift(    en4["bilap"].RPE[1:$iter] ./ 1.538 ./ 1e21)
    Ew16 = @lift( en16["weno5dd"].RPE[1:$iter] ./ 1.538 ./ 1e21)
    El16 = @lift(en16["lapleith"].RPE[1:$iter] ./ 1.538 ./ 1e21)
    Eb16 = @lift(   en16["bilap"].RPE[1:$iter] ./ 1.538 ./ 1e21)
    Pw4  = @lift(  en4["weno5dd"].RPE[$iter:$iter] ./ 1.538 ./ 1e21)
    Pl4  = @lift( en4["lapleith"].RPE[$iter:$iter] ./ 1.538 ./ 1e21)
    Pb4  = @lift(    en4["bilap"].RPE[$iter:$iter] ./ 1.538 ./ 1e21)
    Pw16 = @lift( en16["weno5dd"].RPE[$iter:$iter] ./ 1.538 ./ 1e21)
    Pl16 = @lift(en16["lapleith"].RPE[$iter:$iter] ./ 1.538 ./ 1e21)
    Pb16 = @lift(   en16["bilap"].RPE[$iter:$iter] ./ 1.538 ./ 1e21)
